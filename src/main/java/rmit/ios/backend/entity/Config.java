	...
	CommandLineRunner commandLineRunner(UserRepository userRepository, CastRepository castRepository,
		...
		return args -> {
			...
			castRepository.saveAll(List.of(
					...
					cast81, cast82, cast83, cast84, cast85, cast86, cast87, cast78, cast89, cast90,
...
// cast10, cast11, cast12, cast13, cast14, cast15, cast16, cast17, cast18,
// cast19,
// cast20, cast21, cast22, cast23, cast24, cast25, cast26, cast27, cast28,
// cast29,
// cast30, cast31, cast32, cast33, cast34, cast35, cast36, cast37, cast38,
// cast39,
// cast40, cast41, cast42, cast43, cast44, cast45, cast46, cast47, cast48,
// cast49,
// cast50, cast51, cast52, cast53, cast54, cast55, cast56, cast57, cast58,
// cast59,
// cast60, cast61, cast62, cast63, cast64, cast65, cast66, cast67, cast68,
// cast69));
...
// "die-hard",
// 8.8,
// "NYPD cop John McClane goes on a Christmas vacation to visit his wife Holly
// in Los Angeles where she works for the Nakatomi Corporation. While they are
// at the Nakatomi headquarters for a Christmas party, a group of robbers led by
// Hans Gruber take control of the building and hold everyone hostage, with the
// exception of John, while they plan to perform a lucrative heist.",
// "John McTiernan",
// List.of(cast31, cast30, cast32, cast23),
// List.of(genre2, genre8));
...
// "die-hard-3",
// 7.6,
// "John McClane is now almost a full-blown alcoholic and is suspended from the
// NYPD. But when a bomb goes off in the Bonwit Teller Department Store the
// police go insane trying to figure out what's going on. Soon, a man named
// Simon calls and asks for McClane. Simon tells Inspector Walter Cobb that
// McClane is going to play a game called Simon. He says that McClane is going
// to do the tasks he assigns him.",
// "John McTiernan",
// List.of(cast29, cast31, cast30, cast26, cast25),
// List.of(genre2, genre8));
...
// "live-free-or-die-hard",
// 8.8,
// "When someone hacks into the computers at the FBI's Cyber Crime Division; the
// Director decides to round up all the hackers who could have done this. When
// he's told that because it's the 4th of July most of their agents are not
// around so they might have trouble getting people to get the hackers. So he
// instructs them to get local PD'S to take care of it. And one of the cops they
// ask is John McClane who is tasked with bringing a hacker named Farrell to the
// FBI. But as soon as he gets there someone starts shooting at them.",
// "Len Wiseman",
// List.of(cast29, cast31, cast27, cast30),
// List.of(genre2, genre8));
...
// "thor",
// 6.8,
// "Thor is exiled by his father, Odin, the King of Asgard, to the Earth to live
// among mortals. When he lands on Earth, his trusted weapon Mjolnir is
// discovered and captured by S.H.I.E.L.D.",
// "Kenneth Branagh",
// List.of(cast19, cast10, cast20, cast21),
// List.of(genre2, genre9, genre5));
...
// "thor-2",
// 6.8,
// "Thor sets out on a journey to defeat Malekith, the leader of the Dark Elves
// when he returns to Asgard to retrieve a dangerous weapon and fulfill his
// desire of destroying the Nine Realms.",
// "Alan Taylor",
// List.of(cast12, cast14, cast15, cast16, cast17, cast18),
// List.of(genre2, genre9, genre5));
...
// "thor-3",
// 7.1,
// "Deprived of his mighty hammer Mjolnir, Thor must escape the other side of
// the universe to save his home, Asgard, from Hela, the goddess of death.",
// "Taika Waititi",
// List.of(cast12, cast14, cast15, cast16, cast17, cast18),
// List.of(genre2, genre9, genre5));
...
// "thor-4",
// 6.7,
// "Thor: Love and Thunder is a 2022 American superhero film based on Marvel
// Comics featuring the character Thor, produced by Marvel Studios and
// distributed by Walt Disney Studios Motion Pictures. It is the sequel to Thor:
// Ragnarok and the 29th film in the Marvel Cinematic Universe.",
// "Taika Waititi",
// List.of(cast12, cast14, cast15, cast16, cast17, cast18),
// List.of(genre2, genre9, genre5));
...
// "iron-man-1",
// 7.9,
// "When Tony Stark, an industrialist, is captured, he constructs a high-tech
// armoured suit to escape. Once he manages to escape, he decides to use his
// suit to fight against evil forces to save the world.",
// "Jon Favreau",
// List.of(cast12, cast14, cast13, cast6),
// List.of(genre2, genre3, genre5));
...
// "iron-man-2",
// 7.9,
// "Tony Stark is under pressure from various sources, including the government,
// to share his technology with the world. He must find a way to fight them
...
// "iron-man-3",
// 7.1,
// "Tony Stark encounters a formidable foe called the Mandarin. After failing to
// defeat his enemy, Tony embarks on a journey of self-discovery as he fights
// against the powerful Mandarin.",
// "Jon Favreau",
// List.of(cast12, cast14, cast15, cast16, cast17, cast18),
// List.of(genre2, genre3, genre5));
...
// "star-trek-3",
// 7.0,
// "The crew of the USS Enterprise explores the furthest reaches of uncharted
// space, where they encounter a new ruthless enemy, who puts them, and
...
// "pacific-rim",
// 6.9,
// "As a war between humankind and monstrous sea creatures wages on, a former
// pilot and a trainee are paired up to drive a seemingly obsolete special
// weapon in a desperate effort to save the world from the apocalypse.",
// "Guillermo del Toro",
// List.of(cast40, cast37, cast38, cast39),
// List.of(genre5, genre2, genre3));
...
// "pacfic-rim-uprising",
// 5.6,
// "Jake Pentecost, son of Stacker Pentecost, reunites with Mako Mori to lead a
// new generation of Jaeger pilots, including rival Lambert and 15-year-old
// hacker Amara, against a new Kaiju threat.",
// "Steven S. DeKnight",
// List.of(cast41, cast40, cast38, cast37),
// List.of(genre5, genre2, genre3));
...
// "three-thousand-years-of-longing",
// 6.9,
// "Three Thousand Years of Longing is a 2022 fantasy romantic drama film
// directed by George Miller and starring Tilda Swinton and Idris Elba. Miller
// wrote the screenplay with Augusta Gore, adapting the 1994 short story The
...
// "titanic",
// 7.9,
// "Seventeen-year-old Rose hails from an aristocratic family and is set to be
// married. When she boards the Titanic, she meets Jack Dawson, an artist, and
...
// "365-days-of-summer",
// 7.7,
// "After being dumped by the girl he believes to be his soulmate, hopeless
// romantic Tom Hansen reflects on their relationship to try and figure out
// where things went wrong and how he can win her back.",
// "Marc Webb",
// List.of(cast49, cast50, cast51, cast47),
// List.of(genre10, genre11, genre));
...
// "purple-hearts",
// 6.7,
// "In spite of their many differences, Cassie, a struggling singer-songwriter,
// and Luke, a troubled Marine, agree to marry solely for military benefits. But
// when tragedy strikes, the line between real and pretend begins to blur.",
// "Elizabeth Allen Rosenbaum",
// List.of(cast, cast1, cast3, cast4),
// List.of(genre, genre1, genre2));
...
// "fifty-shades-freed",
// 4.5,
// "Anastasia and Christian get married, but Jack Hyde continues to threaten
// their relationship.",
// "James Foley",
// List.of(cast23, cast52, cast54, cast44),
// List.of(genre10, genre, genre8));
...
// "house-of-the-dragon",
// 8.8,
// "House of the Dragon tells the story of an internal succession war within
// House Targaryen at the height of its power, 172 years before the birth of
// Daenerys Targaryen.",
// "Ryan J. Condal",
...
// "the-witcher",
// 8.2,
// "Geralt of Rivia, a solitary monster hunter, struggles to find his place in a
...
// "peaky-blinders",
// 8.8,
// "A gangster family epic set in 1900s England, centering on a gang who sew
// razor blades in the peaks of their caps, and their fierce boss Tommy
// Shelby.",
// "Steven Knight",
...
// movieRepository.saveAll(List.of(
// movie, movie1, movie2, movie3, movie4, movie5, movie6, movie7, movie8,
// movie9,
